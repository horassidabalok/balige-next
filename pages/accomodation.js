...
export default function Catalogue(){
    ...
    let acdata = data.accomodation

    acdata[0].alamat
    acdata[0].deskripsi
    acdata[0].featuredFoto
    acdata[0].rating
    acdata[0].links
    acdata[0].jamBuka
    acdata[0].nFoto
                    ...
                    acdata.map((i, id) => {
                        return (
                            <div class="col-md-4 col-sm-12 col-lg-3 col-12 row" key={i} id={"c"+i} style={{
                                padding : 0,
                                margin : 0,
                                "background": `linear-gradient( rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.7) ), url('${data.storageurl}/akomodasi/${i.nama}/${i.featuredFoto}.png')`,
                                backgroundSize : "cover",
                                color: "white",
                                height:"250px",
                            }}>
                                    <div class="col-12 d-flex align-items-center justify-content-left px-5" style={{}} id="aco-1">
                                    <Link href={"accomodation/"+id} style={{
                                        color : 'white',
                                        textDecoration : 'none'
                                    }}>
                                        <h3>{i.nama}</h3>
