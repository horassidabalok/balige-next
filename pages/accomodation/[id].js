...
export default function Destination({data}){
    ...
    let selecteddata = data.accomodation[parseInt(id)]
    ...
    for(let i = 0; i < selecteddata.nFoto; i++){
        gallery = <>
            ...
            <div key={i} class={deststy.gambar+" col-md-4 col-sm-6 col-lg-3 col-6"}>
                <img height={150} width={100} src={data.storageurl+"/akomodasi/"+selecteddata.nama+"/"+i+".png"} class={" col-12"} alt="" srcset=""/>
            </div>
        </>
    }
    ...
    return <>
        ...
        <div className={deststy.uppercontainer}>
            ...
            <div className="col-lg-8 col-md-6 col-sm-12" style={{
                ...
                <img src={data.storageurl+"/akomodasi/"+selecteddata.nama+"/"+selecteddata.featuredFoto+".png"} className={deststy.featpict + " col-12"}/>
            </div>
        </div>
